...
function generateSlug(title: string): string {
  const map: Record<string, string> = {
    ...
    '메타': 'meta', '릴스': 'reels', '쓰레드': 'threads', '스토리': 'story',
    '피드': 'feed', '틱톡': 'tiktok', '유튜브': 'youtube',
    // 마케팅 용어
    ...
    '리타게팅': 'retargeting', '타겟팅': 'targeting',
    '캠페인': 'campaign', '광고비': 'ad-spend', '클릭': 'click',
    '전환': 'conversion', '노출': 'impression', '도달': 'reach',
    '해시태그': 'hashtag', '알고리즘': 'algorithm',
    '팔로워': 'follower', '데드존': 'deadzone', '사이즈': 'size',
    '콘텐츠': 'content', '계정': 'account', '인게이지먼트': 'engagement',
    // AI 관련
    '인공지능': 'ai', '챗봇': 'chatbot', '자동화': 'automation',
    '생산성': 'productivity', '도구': 'tools', '플러그인': 'plugin',
    '모델': 'model', '업데이트': 'update', '출시': 'release',
    '기능': 'features', '사용법': 'usage', '설치': 'install',
    '설정': 'setup', '활용': 'tips', '추천': 'recommend',
    '비교': 'comparison', '분석': 'analysis', '정리': 'summary',
    // 일반
    '완벽': 'complete', '필수': 'essential', '최신': 'latest',
    '새로운': 'new', '영상': 'video', '편집': 'edit', '앱': 'app',
  };
