...
const whyPolaad = [
  {
    ...
    title: "중소기업을 이해합니다",
    description:
      "제한된 예산으로도 효율적인 리드 수집이 가능합니다. 복잡한 시스템 없이 카카오 로그인과 텔레그램 알림으로 간편하게 시작하세요.",
  },
  {
    icon: Users,
    title: "올인원 솔루션",
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  ...
                  <p className="text-white font-medium break-keep">
                    &ldquo;모든 중소기업이 24시간 일하는 온라인 영업사원을 가질
                    수 있도록&rdquo;
                  </p>
                </motion.div>
                ...
                >
                  <Button
                    variant="primary"
                    size="xl"
                    className="w-full sm:w-auto shadow-xl shadow-primary-900/20 border border-primary-500/50"
                    href="/contact"
                  >
                    무료 상담 신청
