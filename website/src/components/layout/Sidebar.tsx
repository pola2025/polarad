...
const navigation: NavEntry[] = [
  { href: "/dashboard", label: "대시보드", icon: LayoutDashboard },
  {
    ...
    defaultOpen: true,
    items: [
      { href: "/dashboard/submission", label: "자료 제출", icon: FileUp },
      { href: "/dashboard/homepage", label: "홈페이지 제작요청", icon: Globe },
      { href: "/dashboard/workflows", label: "제작 현황", icon: BarChart3 },
    ],
  },
  { href: "/dashboard/communication", label: "문의하기", icon: MessageSquare },
  {
    label: "가이드",
    icon: BookOpen,
    defaultOpen: false,
    items: [
      { href: "/dashboard/guides", label: "참고가이드", icon: BookMarked },
      { href: "/dashboard/meta-ads", label: "Meta 광고", icon: Megaphone },
      { href: "/dashboard/design-threads", label: "시안 확인", icon: Eye },
      {
