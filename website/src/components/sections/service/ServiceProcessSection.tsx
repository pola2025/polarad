...
export default function ServiceProcessSection() {
  return (
    <section className="py-12 lg:py-28 bg-gray-900 overflow-hidden relative">
      ...
      <div className="container relative z-10">
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Description */}
                <p className="relative z-10 text-sm text-gray-300 break-keep">
                  {step.description}
                </p>
              </motion.div>
            );
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 shrink-0">
                      <div
                        className={`w-12 h-12 rounded-full ${colors} border flex items-center justify-center`}
                      >
        ...
        >
          <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 rounded-full bg-primary-500/10 border border-primary-500/30">
            <span className="text-gray-300 text-xs sm:text-sm lg:text-base whitespace-nowrap">
              총 예상 소요기간
            </span>
            <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500 shrink-0" />
            <span className="text-sm sm:text-base lg:text-lg font-bold text-primary-400 whitespace-nowrap">
              30일 이내 완료 목표
            </span>
          </div>
          <p className="text-xs sm:text-sm text-white">
            * 클라이언트 피드백에 따라 기간은 연장될 수 있습니다.
          </p>
        </motion.div>
      </div>
    </section>
