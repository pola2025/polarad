        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              <div
                className={`w-12 h-12 rounded-xl ${colorClasses.amber.iconBg} flex items-center justify-center`}
              >
                <Printer className={`w-6 h-6 ${colorClasses.amber.icon}`} />
              </div>
              <h3 className="text-xl font-bold text-white">
                {addons.printMaterials.title}
              </h3>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              <div
                className={`w-12 h-12 rounded-xl ${colorClasses.emerald.iconBg} flex items-center justify-center`}
              >
                <Target className={`w-6 h-6 ${colorClasses.emerald.icon}`} />
              </div>
              <h3 className="text-xl font-bold text-white">
                {addons.metaAutomation.title}
              </h3>
            </div>
            <p className="text-gray-500 text-sm mb-6 ml-15">
              {addons.metaAutomation.description}
            </p>
              ...
              <div className="flex justify-between items-center">
                <div>
                  <span className="text-white">
                    {addons.metaAutomation.extra.name}
                  </span>
                  <span className="text-gray-500 text-xs ml-2">
                    ({addons.metaAutomation.extra.note})
                  </span>
                </div>
                <span className="text-emerald-400 font-bold">
                  {addons.metaAutomation.extra.price}
                </span>
              </div>
            </div>
          </motion.div>
