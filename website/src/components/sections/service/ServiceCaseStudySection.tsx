...
export default function ServiceCaseStudySection() {
  return (
    <section
      id="case-study"
      className="py-12 lg:py-28 bg-gray-900 scroll-mt-20"
    >
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {caseStudies.map((caseStudy, index) => {
            ...
            const colors =
              colorClasses[caseStudy.color as keyof typeof colorClasses];
                ...
                <div className={`${colors.headerBg} px-4 sm:px-6 py-3`}>
                  <div className="flex items-center justify-between whitespace-nowrap">
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      <span className="text-white/70 text-[11px] sm:text-sm">
                        이용 고객 사례
                      </span>
                    </div>
                ...
                <div className={`${colors.bg} p-6 lg:p-8`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className={`font-bold text-lg ${colors.highlight}`}>
                  ...
                  {/* Highlight */}
                  <div
                    className={`mt-6 pt-4 border-t border-gray-800 flex items-center gap-2 ${colors.highlight}`}
                  >
