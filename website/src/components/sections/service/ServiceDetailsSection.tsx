    ...
    >
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4">
          <div
            className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl ${colors.icon} flex items-center justify-center shrink-0`}
          >
            <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <h3 className="text-[13px] sm:text-base lg:text-lg font-bold text-gray-900 whitespace-nowrap">
            {title}
          </h3>
        </div>
        <motion.div
            ...
            <div className="space-y-6">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>
                    • 로고 AI 파일(일러스트 형식)을 반드시 제공해주셔야 합니다.
                  </li>
                  <li>• 로고가 없는 경우, 로고 없이 제작이 진행됩니다.</li>
                  <li>
                    • 최종 승인 후 발주된 인쇄물의 오탈자로 인한 재인쇄는 고객
                    부담입니다.
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-[11px] sm:text-xs lg:text-sm text-gray-600">
                  <li className="whitespace-nowrap">
                    • <strong className="text-gray-800">1페이지</strong> =
                    헤더/푸터 제외 5개 섹션 이하
                  </li>
                  <li className="whitespace-nowrap">
                    • <strong className="text-gray-800">섹션</strong> = 설명
                    또는 서비스 안내 항목 1개 영역
                  </li>
                  <li className="whitespace-nowrap">
                    • 섹션이 5개 초과 시 추가 페이지로 계산
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      광고 소재(이미지/영상)는{" "}
                      <strong className="text-gray-900">직접 준비</strong>
                      해주셔야 합니다.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <p className="text-gray-700 text-sm break-keep">
                  폴라애드는 광고 세팅과 최적화를 지원합니다.
                  <br />
                  전달주신 소재로 타겟 설정, 자동화, 리포팅까지 모두
                  대행해드립니다.
                </p>
              </div>
            </div>
