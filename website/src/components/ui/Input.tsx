...
export function Input({
  ...
  const variantStyles = {
    dark: {
      ...
      input: 'bg-dark-800 text-text-primary border-dark-600 placeholder:text-text-muted focus:border-neon-cyan-500 focus:shadow-neon-cyan',
      helper: 'text-text-tertiary'
    },
    light: {
      label: 'text-gray-700',
      input: 'bg-gray-50 text-gray-900 border-gray-300 placeholder:text-gray-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20',
