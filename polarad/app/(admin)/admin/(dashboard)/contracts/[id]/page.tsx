...
export default function AdminContractDetailPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      const res = await fetch(`/api/admin/contracts/${params.id}/approve`, {
        method: "POST",
      });
  ...
  const handleReject = async () => {
    ...
    try {
      const res = await fetch(`/api/admin/contracts/${params.id}/reject`, {
        method: "POST",
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <InfoRow label="주소" value={contract.address} icon={<MapPin className="w-4 h-4" />} />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <InfoRow label="연락처" value={contract.contactPhone} icon={<Phone className="w-4 h-4" />} />
                <div className="md:col-span-2">
                  <InfoRow label="이메일" value={contract.contactEmail} icon={<Mail className="w-4 h-4" />} />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <Badge variant={contract.user.telegramEnabled ? "success" : "default"}>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-blue-600 font-medium">
                    {contract.package.price === 0 ? "별도 협의" : `${formatCurrency(contract.package.price)}/월`}
                  </p>
                </div>
...
function InfoRow({
  ...
  return (
    <div>
      ...
      <p className={`flex items-center gap-1.5 ${highlight ? "text-lg font-bold text-blue-600" : "text-gray-900 dark:text-white"}`}>
        {icon}
        {value}
      </p>
    </div>
