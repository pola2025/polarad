      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">14일 이내 만료</p>
          </CardContent>
        </Card>

        <Card className="bg-red-50 dark:bg-red-900/20">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">긴급 (3일 이내)</CardTitle>
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">토큰 갱신 필요</p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {stats?.authRequired || 0}
            </div>
            <p className="text-xs text-muted-foreground">Meta 재연동 필요</p>
          </CardContent>
        </Card>
      </div>
