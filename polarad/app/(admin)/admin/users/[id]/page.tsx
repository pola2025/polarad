                  ...
                  <div className="flex flex-wrap gap-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, smsConsent: e.target.checked })
                        }
                        className="rounded"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, emailConsent: e.target.checked })
                        }
                        className="rounded"
                      />
            ...
            {user.submission ? (
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <Badge
                    variant={user.submission.isComplete ? "success" : "warning"}
                  >
                  ...
                  <tbody>
                    {user.workflows.map((workflow) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <Badge
                            variant={getWorkflowStatusVariant(workflow.status) as "success" | "warning" | "error" | "info" | "secondary"}
                          >
